...
namespace Application.PersonController.Queries.GetPersonList.Models
{
    public class GetPersonListDto : IMapFrom<Person>
    {
        ...
        {
            profile.CreateMap<Person, GetPersonListDto>()
